...
@click.option('--robot_ip', '-ri', default="127.0.0.0", help="ARX5's IP address e.g. 192.168.0.204")
@click.option('--robot_port', '-rp', default=8766, help="ARX5 robot port number")
...
def main(input, output, robot_ip, robot_port, match_dataset, match_episode,
            ...
            #     iter_idx = 0
                ...
                try:
                    ...
                    while True:
                        ...
                        # if delta_action:
                        #     assert len(action) == 1
                        #     if perv_target_pose is None or perv_target_gripper_pos is None:
                        #         perv_target_pose = obs['eef_pose'][-1]
                        #         perv_target_gripper_pos = obs['gripper_pos'][-1]
                        #     this_target_pose = perv_target_pose.copy()
                        #     this_target_gripper_pos = perv_target_gripper_pos.copy()
                        ...
                        # No need to convert action to env actions
